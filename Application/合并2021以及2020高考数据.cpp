...
private:
    ...
    std::string path_2020 = "C:\\Users\\jinue\\Desktop\\数据\\2020数据\\2020\\2020文科二本.csv";
    std::string outpath = "D:\\xue_workspace\\DataOfUniversityScore\\ExcelPythonTest\\20220204\\文科二本\\";
...
void Dataset_classification::readfile() {
    ...
    for (int i = 0;i < Major_arr.size(); i++) {
        ...
        out.open(outpath + variable_path + "文科二本2021以及2020年在吉专业分数及位次" + ".csv", std::ios::out | std::ios::binary);
        if (out.fail()) {
